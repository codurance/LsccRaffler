...
resource "aws_elastic_beanstalk_environment" "lsccraffler" {
  ...
  application            = aws_elastic_beanstalk_application.lsccraffler.name
  ...
  # This is temporal, to have the initial setup. But we want to setup HTTPS as soon as possible
  # setting {
